...
static const std::string OPENCV_WINDOW = "Pokemon Search_tb3_0";
...
public:
    ...
    : it_(nh_)
  {
    ...
    image_sub_ = it_.subscribe("tb3_0/kinect/rgb/image_raw", 1,
      &ImageConverter::imageCb, this);
    image_pub_ = it_.advertise("tb3_0/pokemon_go/searcher", 1);
