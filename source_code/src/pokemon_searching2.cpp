...
static const std::string OPENCV_WINDOW = "Pokemon Search_tb3_2";
...
public:
    ...
    : it_(nh_)
  {
    ...
    image_sub_ = it_.subscribe("tb3_2/kinect/rgb/image_raw", 1,
      &ImageConverter::imageCb, this);
    image_pub_ = it_.advertise("tb3_2/pokemon_go/searcher", 1);
